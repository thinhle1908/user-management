...
<nav class="navbar navbar-expand-lg mt-3 navbar-light navbar-laravel">
    <div class="container">
                        ...
                        <div class="card-body">
                            ...
                            @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="password" id="user_name" class="form-control" name="password" value="{{$user->password}}">
                                    </div>
                                </div>
